...
SCENARIO("Attempting to compile a recursion specification with an empty group specification results in an exception","[regex][recursion]") {
...
SCENARIO("Attempting to compile an unterminated recursion specification results in an exception","[regex][recursion]") {
...
SCENARIO("Attempting to reference a group that does not exist in a recursion specification results in an exception","[regex][recursion]") {
